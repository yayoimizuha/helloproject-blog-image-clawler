...
#
#
# load pre-selected images in face_dataset/${USER}/training_data
# add file system member's tag to image
#
#
...
obama_image = face_recognition.load_image_file(os.path.join(os.getcwd(), 'sample_images', 'obama.jpg'))
obama_face_encoding = face_recognition.face_encodings(obama_image)[0]

# Load a second sample picture and learn how to recognize it.
biden_image = face_recognition.load_image_file(os.path.join(os.getcwd(), 'sample_images', 'biden.jpg'))
...
for image in exist_file:
    unknown_image = face_recognition.load_image_file(os.path.join(os.getcwd(), 'images', image))
    ...
    for (top, right, bottom, left), face_encoding in zip(face_locations, face_encodings):
        ...
        # Draw a label1 with a name below the face
